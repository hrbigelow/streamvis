...
const (
	...
	// ServiceGetEndChunkIdProcedure is the fully-qualified name of the Service's GetEndChunkId RPC.
	ServiceGetEndChunkIdProcedure = "/streamvis.v1.Service/GetEndChunkId"
...
func NewServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ServiceClient {
	...
	return &serviceClient{
		...
		addRunTags: connect.NewClient[v1.AddRunTagsRequest, v1.AddRunTagsResponse](
			...
			connect.WithSchema(serviceMethods.ByName("AddRunTags")),
			connect.WithClientOptions(opts...),
		),
		...
		getEndChunkId: connect.NewClient[v1.GetEndChunkIdRequest, v1.GetEndChunkIdResponse](
			httpClient,
			baseURL+ServiceGetEndChunkIdProcedure,
...
func (c *serviceClient) ListFields(ctx context.Context, req *v1.ListFieldsRequest) (*connect.ServerStreamForClient[v1.Field], error) {
...
// GetEndChunkId calls streamvis.v1.Service.GetEndChunkId.
func (c *serviceClient) GetEndChunkId(ctx context.Context, req *v1.GetEndChunkIdRequest) (*v1.GetEndChunkIdResponse, error) {
	response, err := c.getEndChunkId.CallUnary(ctx, connect.NewRequest(req))
	if response != nil {
		return response.Msg, err
	}
	return nil, err
...
func NewServiceHandler(svc ServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	serviceGetEndChunkIdHandler := connect.NewUnaryHandlerSimple(
		ServiceGetEndChunkIdProcedure,
		svc.GetEndChunkId,
		connect.WithSchema(serviceMethods.ByName("GetEndChunkId")),
		connect.WithHandlerOptions(opts...),
	)
	...
	return "/streamvis.v1.Service/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case ServiceGetEndChunkIdProcedure:
			serviceGetEndChunkIdHandler.ServeHTTP(w, r)
...
func (UnimplementedServiceHandler) GetEndChunkId(context.Context, *v1.GetEndChunkIdRequest) (*v1.GetEndChunkIdResponse, error) {
